...
BLOG_EMAIL = "jeremy@onemanairforce.com"
BLOG_DESCRIPTION = "Promotinoal Site for One Man Air Force"  # (translatable)
...
PAGES = (
    ...
    ("/home/jeremy/Documents/one_man_air_force/website//*.md", "pages", "page.tmpl"),
